    ...
    <div className="relative">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-salsa-900/20 via-merengue-900/20 to-cumbia-900/20"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-fade-in">
            <h1 className="font-display text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-bold mb-6">
              <span className="block bg-gradient-to-r from-salsa-400 via-merengue-400 to-cumbia-400 bg-clip-text text-transparent animate-slide-up">
                Son2
              </span>
              <span className="block text-4xl sm:text-5xl md:text-6xl lg:text-7xl mt-2 bg-gradient-to-r from-cumbia-300 to-salsa-300 bg-clip-text text-transparent animate-slide-up" style={{ animationDelay: '0.2s' }}>
                Latín Music
              </span>
            </h1>
            
            <p className="text-xl sm:text-2xl md:text-3xl text-gray-300 mb-4 font-display italic animate-slide-up" style={{ animationDelay: '0.4s' }}>
              Our Latin Thing
            </p>
            
            <p className="text-lg sm:text-xl text-gray-400 mb-12 max-w-3xl mx-auto animate-slide-up" style={{ animationDelay: '0.6s' }}>
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
          <div className="w-6 h-10 border-2 border-salsa-400 rounded-full flex justify-center">
            <div className="w-1 h-3 bg-salsa-400 rounded-full mt-2 animate-pulse"></div>
          </div>
        </div>
      </section>
